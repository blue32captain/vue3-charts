...
For ChartJS 2, see [v0.3.0](https://github.com/blue32captain/vue3-charts/tree/0.3.0)
...
```shell script
yarn add chart.js @blue32captain/vue3-charts

npm install chart.js @blue32captain/vue3-charts
```
