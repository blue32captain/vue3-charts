<template>
  <div style="width: 100%;height:20%;display: block;">
    <vue3-charts ref="chartRef" v-bind="{...barChart}" @after-update="afterUpdate"/>
  </div>
  <div style="display: none;">
    <vue3-charts v-bind="{...localDoughnutChartOptions}" @after-render="afterRender"/>
  </div>
